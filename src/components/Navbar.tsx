                  ...
                  >
                    <Link
                      ...
                      style={{
                        ...
                        color: isActive(item.path) ? '#ffffff' : '#2563eb'
                      }}
                    >
            ...
            {isAuthenticated ? (
              <div className="flex items-center space-x-4">
                <Link
                  ...
                  className="flex items-center space-x-1 px-4 py-2 rounded-lg transition-all duration-300"
                  style={{
                    backgroundColor: isActive('/admin') ? '#2563eb' : 'transparent',
                    color: isActive('/admin') ? '#ffffff' : '#2563eb'
                  }}
                >
                ...
                <motion.button
                  ...
                  whileTap={{ scale: 0.95 }}
                  onClick={logout}
                  className="px-4 py-2 rounded-lg transition-colors text-blue-600"
                >
                  Logout
                </motion.button>
              </div>
              ...
              <Link
                to="/login"
                className="flex items-center space-x-1 px-4 py-2 rounded-lg transition-colors text-blue-600"
              >
                <User className="w-4 h-4" />
                <span>Login</span>
              </Link>
